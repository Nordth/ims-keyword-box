...
var script$1 = {
  ...
  methods: {
    ...
    _pasteCommandImpl(cursor, cur_value, text, emit_callback = null) {
      ...
      const split = this.splittingRegexp ? text.split(this.splittingRegexp) : [text]; // Preprocess keywords
    ...
    _getKeywordClasses(keyword, keyword_index) {
      ...
      if (this.getKeywordClasses) {
        ...
        if (user_classes) {
          if (typeof user_classes === 'string') classes[user_classes] = true;else if (Array.isArray(user_classes)) user_classes.forEach(cl => classes[cl] = true);else Object.assign(classes, user_classes);
        }
      }
...
var __vue_render__$1 = function () {
  ...
  return _c('div', {
    ...
    return [_c('span', {
      ...
      attrs: {
        "draggable": !_vm.isMobile,
        "data-kwd-ind": keyword_index
      }
    }, [_c('span', {
      staticClass: "ImsKeywordBox-keyword",
      class: _vm._getKeywordClasses(keyword, keyword_index)
    }, [_vm._showInsideSeparatorBefore(keyword_index) ? _c('span', {
      staticClass: "ImsKeywordBox-separator-inside"
    }, [_vm._v(_vm._s(keyword_index === 0 ? _vm.separatorComp.first : _vm.separatorComp.text))]) : _vm._e(), _vm._v(_vm._s(keyword)), _vm._showInsideSeparatorAfter(keyword_index) ? _c('span', {
      staticClass: "ImsKeywordBox-separator-inside"
    }, [_vm._v(_vm._s(keyword_index === 0 ? _vm.separatorComp.first : _vm.separatorComp.text))]) : _vm._e(), _vm.showDeleteButton ? _c('span', {
      staticClass: "ImsKeywordBox-keyword-delete",
      on: {
        "click": function ($event) {
          return _vm._onDeleteKeywordButtonClick(keyword_index);
        }
      }
  ...
  })], _vm._v(" "), (!_vm.value || !_vm.value.length) && _vm.editorPosition === 0 || _vm.value && _vm.editorPosition === _vm.value.length ? _c('ims-keyword-box-editor', {
    ref: "editor",
    staticClass: "ImsKeywordBox-editor",
    on: {
      "blur": _vm._editorCommit,
